...
- Detailed outcomes use structured tracing fields such as reason code, relative path, Tidal Album IDs, and the underlying filesystem error. They are not stored in the database or returned as an unbounded result list.
